...
export default function Header({
  ...
  const [profileImage, setProfileImage] = React.useState(localStorage.getItem("profileImage") || "Profile.jpg");

  React.useEffect(() => {
    const handleStorageChange = () => {
      setProfileImage(localStorage.getItem("profileImage") || "Profile.jpg");
    };
