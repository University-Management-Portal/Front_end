...
function UserFilterBar({ filter, setFilter }) {
  return (
    <div className='mt-[10px] p-[40px] py-[30px] bg-[#16025d] flex justify-center gap-[60px] flex-wrap rounded-[14px] items-center'>
